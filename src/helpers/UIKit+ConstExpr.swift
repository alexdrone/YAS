...
#if canImport(UIKit)
let defaultUIKitConstExpr: [String: Double] = [
  // Idiom.
...
let defaultUIKitSymbols: [Expression.Symbol: Expression.SymbolEvaluator] = [
  .variable("idiom"): { _ in
...
public class Screen {
  ...
  public enum SizeClass: Int, Codable {
    ...
    /// The device's horizontal size class.
    ...
    /// The device's vertical size class.
